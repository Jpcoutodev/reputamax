...
export const siteConfig = {
  ...
  description:
    "Transforme avaliações do Google em uma máquina de atrair clientes. Diagnóstico gratuito da sua reputação, página de avaliação inteligente que filtra críticas, QR code e respostas com IA. 14 dias grátis, sem cartão.",
